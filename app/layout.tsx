        ...
        <Providers>
          ...
          <div className="flex flex-col items-center justify-start font-poppins max-w-5xl">
            ...
            <div className="social flex justify-center align-middle mt-3">
              <a href="https://www.github.com/gkcodez" target="_blank"><IoLogoGithub className="text-gray-600 dark:text-gray-200 text-6xl p-2" /></a>
              <a href="https://www.linkedin.com/in/gkcodez" target="_blank"><IoLogoLinkedin className="text-sky-600 dark:text-sky-400 text-6xl p-2" /></a>
              <a href="mailto:gopalakrishnan.work@gmail.com" target="_blank"><IoMail className="text-amber-600 dark:text-amber-400 text-6xl p-2" /></a>
            </div>
